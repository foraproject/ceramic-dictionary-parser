(function() {
    ...
    */
    ...
    var DictParser = function(dict, getter, ceramic, options) {
        this.dict = dict;
        this.ceramic = ceramic;
        this.getter = getter || function*(dict, name) { return dict[name]; };
        if (!options)
            options = {};
    ...
    DictParser.prototype.getField = function*(name, def) {
        ...
        var value = yield* this.getter(name, this.dict);
    ...
    DictParser.prototype.map = function*(target, entitySchema, whitelist, options, parents) {
        ...
        whitelist = whitelist.map(function(e) {
            return e.split(self.options.delimiter);
        });
